...
const salt3 = Buffer.from([123]);
const salt4 = crypto.randomBytes(16);
const salt5 = Buffer.from([123]);
const iterations = 1000000;
const password = 'your-password'; 
const keyLength = 32; 
const digest = 'sha256';

crypto.pbkdf2(password, salt2, iterations, keyLength, digest, (err, derivedKey) => {
    if (err) throw err;
